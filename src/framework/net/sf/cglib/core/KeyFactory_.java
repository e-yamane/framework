 ...
 */
abstract public class KeyFactory_ {
    ...
    protected KeyFactory_() {
    }

    public static KeyFactory_ create(Class keyInterface) {
        return create(keyInterface, null);
    }

    public static KeyFactory_ create(Class keyInterface, Customizer customizer) {
        return create(keyInterface.getClassLoader(), keyInterface,  customizer);
    }

    public static KeyFactory_ create(ClassLoader loader, Class keyInterface, Customizer customizer) {
    ...
    public static class Generator extends AbstractClassGenerator {
        private static final Source SOURCE = new Source(KeyFactory_.class.getName());
        ...
        public KeyFactory_ create() {
            setNamePrefix(keyInterface.getName());
            return (KeyFactory_)super.create(keyInterface.getName());
        }
