...
public abstract class BaseUnit  implements Serializable {
    ...
    **/
    ...
    /**
     * 変換係数。浮動小数点では誤差が生じるため文字列で格納
    **/ 
    private String rateStr;
    public final static String RATE = "rateStr";

    /**
     * 変換係数。浮動小数点では誤差が生じるため文字列で格納を取得する
     * @hibernate.property
     *    column="RATE"
     *    not-null="true"
     *    length="16"
     * @return 変換係数。浮動小数点では誤差が生じるため文字列で格納
    **/
    ...
    /**
     * 変換係数。浮動小数点では誤差が生じるため文字列で格納を設定する
     * @param rateStr  変換係数。浮動小数点では誤差が生じるため文字列で格納
    **/
