...
//change CodeAdapter -> MethodAdapter
public class RemappingCodeVisitor extends MethodAdapter {
    private State state;
    private IntRef check = new IntRef();

    //change(add)
    protected MethodVisitor cv;
    ...
    //change CodeAdapter -> MethodVisitor
    public RemappingCodeVisitor(MethodVisitor v, int access, Type[] args) {
        super(v);
    ...
    public void visitLocalVariable(String name, String desc, String signature, Label start, Label end, int index) {
        cv.visitLocalVariable(name, desc, signature, start, end, remap(index, 0));
    }
